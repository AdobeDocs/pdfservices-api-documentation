                    ...
                    },
                    {
                        ...
                        pages: [
                            ...
                            },
                            {
                                title: 'PDF Services API',
                                subTitle: '',
                                path: '3.0.0/pdf-services-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '3.0.0/pdf-services-api/index.md'
                                    ...
                                    {
                                        title: 'How Tos',
                                        path: '3.0.0/pdf-services-api/howtos',
                                        pages: [
                                            {
                                                title: 'Overview',
                                                path: '3.0.0/pdf-services-api/howtos/index.md'
                                            },
                                            {
                                                title: 'Create PDF',
                                                path: '3.0.0/pdf-services-api/howtos/create-pdf.md'
                                            },
                                            {
                                                title: 'Export PDF',
                                                path: '3.0.0/pdf-services-api/howtos/export-pdf.md'
                                            },
                                            {
                                                title: 'Combine PDF Files',
                                                path: '3.0.0/pdf-services-api/howtos/combine-pdf.md'
                                            },
                                            {
                                                title: 'OCR PDF',
                                                path: '3.0.0/pdf-services-api/howtos/ocr-pdf.md'
                                            },
                                            {
                                                title: 'Compress PDFs',
                                                path: '3.0.0/pdf-services-api/howtos/compress-pdf.md'
                                            },
                                            {
                                                title: 'Linearize PDF',
                                                path: '3.0.0/pdf-services-api/howtos/linearize-pdf.md'
                                            },
                                            {
                                                title: 'Protect PDF',
                                                path: '3.0.0/pdf-services-api/howtos/protect-pdf.md'
                                            },
                                            {
                                                title: 'Remove Protection',
                                                path: '3.0.0/pdf-services-api/howtos/remove-protection.md'
                                            },
                                            {
                                                title: 'Insert Pages',
                                                path: '3.0.0/pdf-services-api/howtos/insert-pages.md'
                                            },
                                            {
                                                title: 'Replace Pages',
                                                path: '3.0.0/pdf-services-api/howtos/replace-pages.md'
                                            },
                                            {
                                                title: 'Delete Pages',
                                                path: '3.0.0/pdf-services-api/howtos/delete-pages.md'
                                            },
                                            {
                                                title: 'Reorder Pages',
                                                path: '3.0.0/pdf-services-api/howtos/reorder-pages.md'
                                            },
                                            {
                                                title: 'Rotate Pages',
                                                path: '3.0.0/pdf-services-api/howtos/rotate-pages.md'
                                            },
                                            {
                                                title: 'Split PDF',
                                                path: '3.0.0/pdf-services-api/howtos/split-pdf.md'
                                            },
                                            {
                                                title: 'Extract PDF',
                                                path: '3.0.0/pdf-services-api/howtos/extract-pdf.md'
                                            },
                                            {
                                                title: 'Get PDF Properties',
                                                path: '3.0.0/pdf-services-api/howtos/pdf-properties.md'
                                            }
                                        ]
                                    },
                                    {
                                        title: 'Version - Support policy',
                                        path: '3.0.0/pdf-services-api/policies.md'
                                    },
                                    {
                                        title: 'Release notes',
                                        path: '3.0.0/pdf-services-api/releasenotes.md'
                                    },
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '3.0.0/pdf-services-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '3.0.0/pdf-services-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            },
                            {
                                title: 'Document Generation API',
                                subTitle: '',
                                path: '3.0.0/document-generation-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '3.0.0/document-generation-api/index.md'
                                    ...
                                    {
                                        title: 'Quickstarts',
                                        path: '3.0.0/document-generation-api/quickstarts.md'
                                    },
                                    {
                                        title: 'Template Tags',
                                        path: '3.0.0/document-generation-api/templatetags.md'
                                    },
                                    {
                                        title: 'Fragments',
                                        path: '3.0.0/document-generation-api/fragments.md'
                                    },
                                    {
                                        title: 'Apply styling and formatting',
                                        path: '3.0.0/document-generation-api/stylingformattingtags.md'
                                    },
                                    {
                                        title: 'Hyperlink',
                                        path: '3.0.0/document-generation-api/hyperlink.md'
                                    },
                                    {
                                        title: 'Dynamic Table Constructs ',
                                        path: '3.0.0/document-generation-api/dynamictableconstructs.md'
                                    },
                                    {
                                        title: 'Word Add-in',
                                        path: '3.0.0/document-generation-api/wordaddin.md'
                                    },
                                    {
                                        title: 'Release Notes',
                                        path: '3.0.0/pdf-services-api/releasenotes.md'
                                    ...
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '3.0.0/document-generation-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '3.0.0/document-generation-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            },
                            {
                                title: 'PDF Extract API',
                                subTitle: '',
                                path: '3.0.0/pdf-extract-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '3.0.0/pdf-extract-api/index.md'
                                    ...
                                    {
                                        title: 'Quickstarts',
                                        path: '3.0.0/pdf-extract-api/quickstarts.md'
                                    },
                                    {
                                        title: 'How Tos',
                                        subTitle: '',
                                        path: '3.0.0/pdf-extract-api/howtos',
                                        pages: [
                                            {
                                                title: 'Overview',
                                                path: '3.0.0/pdf-extract-api/howtos/index.md'
                                            },
                                            {
                                                title: 'PDF Extract API',
                                                path: '3.0.0/pdf-extract-api/howtos/extract-api.md'
                                            }
                                        ]
                                    },
                                    {
                                    ...
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '3.0.0/pdf-extract-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '3.0.0/pdf-extract-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            },
                            {
                                title: 'PDF Accessibility Auto-Tag API',
                                path: '3.0.0/pdf-accessibility-auto-tag-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '3.0.0/pdf-accessibility-auto-tag-api/index.md'
                                    ...
                                    {
                                        title: 'Quickstarts',
                                        path: '3.0.0/pdf-accessibility-auto-tag-api/quickstarts.md'
                                    },
                                    {
                                        title: 'How Tos',
                                        subTitle: '',
                                        path: '3.0.0/pdf-accessibility-auto-tag-api/howtos',
                                        pages: [
                                            {
                                                title: 'Overview',
                                                path: '3.0.0/pdf-accessibility-auto-tag-api/howtos/index.md'
                                            },
                                            {
                                                title: 'PDF Accessibility Auto-Tag API',
                                                path: '3.0.0/pdf-accessibility-auto-tag-api/howtos/accessibility-auto-tag-api.md'
                                            }
                                        ]
                                    },
                                    {
                                    ...
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '3.0.0/pdf-accessibility-auto-tag-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '3.0.0/pdf-accessibility-auto-tag-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            }
                        ]
                    },
                    {
                        ...
                        pages: [
                            ...
                            },
                            {
                                title: 'PDF Services API',
                                subTitle: '',
                                path: '2.2.0/pdf-services-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '2.2.0/pdf-services-api/index.md'
                                    ...
                                    {
                                        title: 'How Tos',
                                        path: '2.2.0/pdf-services-api/howtos',
                                        pages: [
                                            {
                                                title: 'Overview',
                                                path: '2.2.0/pdf-services-api/howtos/index.md'
                                            },
                                            {
                                                title: 'Create PDF',
                                                path: '2.2.0/pdf-services-api/howtos/create-pdf.md'
                                            },
                                            {
                                                title: 'Export PDF',
                                                path: '2.2.0/pdf-services-api/howtos/export-pdf.md'
                                            },
                                            {
                                                title: 'Combine PDF Files',
                                                path: '2.2.0/pdf-services-api/howtos/combine-pdf.md'
                                            },
                                            {
                                                title: 'OCR PDF',
                                                path: '2.2.0/pdf-services-api/howtos/ocr-pdf.md'
                                            },
                                            {
                                                title: 'Compress PDFs',
                                                path: '2.2.0/pdf-services-api/howtos/compress-pdf.md'
                                            },
                                            {
                                                title: 'Linearize PDF',
                                                path: '2.2.0/pdf-services-api/howtos/linearize-pdf.md'
                                            },
                                            {
                                                title: 'Protect PDF',
                                                path: '2.2.0/pdf-services-api/howtos/protect-pdf.md'
                                            },
                                            {
                                                title: 'Remove Protection',
                                                path: '2.2.0/pdf-services-api/howtos/remove-protection.md'
                                            },
                                            {
                                                title: 'Insert Pages',
                                                path: '2.2.0/pdf-services-api/howtos/insert-pages.md'
                                            },
                                            {
                                                title: 'Replace Pages',
                                                path: '2.2.0/pdf-services-api/howtos/replace-pages.md'
                                            },
                                            {
                                                title: 'Delete Pages',
                                                path: '2.2.0/pdf-services-api/howtos/delete-pages.md'
                                            },
                                            {
                                                title: 'Reorder Pages',
                                                path: '2.2.0/pdf-services-api/howtos/reorder-pages.md'
                                            },
                                            {
                                                title: 'Rotate Pages',
                                                path: '2.2.0/pdf-services-api/howtos/rotate-pages.md'
                                            },
                                            {
                                                title: 'Split PDF',
                                                path: '2.2.0/pdf-services-api/howtos/split-pdf.md'
                                            },
                                            {
                                                title: 'Extract PDF',
                                                path: '2.2.0/pdf-services-api/howtos/extract-pdf.md'
                                            },
                                            {
                                                title: 'Get PDF Properties',
                                                path: '2.2.0/pdf-services-api/howtos/pdf-properties.md'
                                            }
                                        ]
                                    },
                                    {
                                        title: 'Version - Support policy',
                                        path: '2.2.0/pdf-services-api/policies.md'
                                    },
                                    {
                                        title: 'Release notes',
                                        path: '2.2.0/pdf-services-api/releasenotes.md'
                                    },
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '2.2.0/pdf-services-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '2.2.0/pdf-services-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            },
                            {
                                title: 'Document Generation API',
                                subTitle: '',
                                path: '2.2.0/document-generation-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '2.2.0/document-generation-api/index.md'
                                    ...
                                    {
                                        title: 'Quickstarts',
                                        path: '2.2.0/document-generation-api/quickstarts.md'
                                    },
                                    {
                                        title: 'Template Tags',
                                        path: '2.2.0/document-generation-api/templatetags.md'
                                    },
                                    {
                                        title: 'Fragments',
                                        path: '2.2.0/document-generation-api/fragments.md'
                                    },
                                    {
                                        title: 'Apply styling and formatting',
                                        path: '2.2.0/document-generation-api/stylingformattingtags.md'
                                    },
                                    {
                                        title: 'Hyperlink',
                                        path: '2.2.0/document-generation-api/hyperlink.md'
                                    },
                                    {
                                        title: 'Dynamic Table Constructs ',
                                        path: '2.2.0/document-generation-api/dynamictableconstructs.md'
                                    },
                                    {
                                        title: 'Word Add-in',
                                        path: '2.2.0/document-generation-api/wordaddin.md'
                                    },
                                    {
                                        title: 'Release Notes',
                                        path: '2.2.0/pdf-services-api/releasenotes.md'
                                    ...
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '2.2.0/document-generation-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '2.2.0/document-generation-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            },
                            {
                                title: 'PDF Extract API',
                                subTitle: '',
                                path: '2.2.0/pdf-extract-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '2.2.0/pdf-extract-api/index.md'
                                    ...
                                    {
                                        title: 'Quickstarts',
                                        path: '2.2.0/pdf-extract-api/quickstarts.md'
                                    },
                                    {
                                        title: 'How Tos',
                                        subTitle: '',
                                        path: '2.2.0/pdf-extract-api/howtos',
                                        pages: [
                                            {
                                                title: 'Overview',
                                                path: '2.2.0/pdf-extract-api/howtos/index.md'
                                            },
                                            {
                                                title: 'PDF Extract API',
                                                path: '2.2.0/pdf-extract-api/howtos/extract-api.md'
                                            }
                                        ]
                                    },
                                    {
                                    ...
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '2.2.0/pdf-extract-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '2.2.0/pdf-extract-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            },
                            {
                                title: 'PDF Accessibility Auto-Tag API',
                                path: '2.2.0/pdf-accessibility-auto-tag-api/index.md',
                                pages: [
                                    {
                                        title: 'Overview',
                                        path: '2.2.0/pdf-accessibility-auto-tag-api/index.md'
                                    ...
                                    {
                                        title: 'Quickstarts',
                                        path: '2.2.0/pdf-accessibility-auto-tag-api/quickstarts.md'
                                    },
                                    {
                                        title: 'How Tos',
                                        subTitle: '',
                                        path: '2.2.0/pdf-accessibility-auto-tag-api/howtos',
                                        pages: [
                                            {
                                                title: 'Overview',
                                                path: '2.2.0/pdf-accessibility-auto-tag-api/howtos/index.md'
                                            },
                                            {
                                                title: 'PDF Accessibility Auto-Tag API',
                                                path: '2.2.0/pdf-accessibility-auto-tag-api/howtos/accessibility-auto-tag-api.md'
                                            }
                                        ]
                                    },
                                    {
                                    ...
                                    {
                                        title: 'PDF Services API Licensing',
                                        path: '2.2.0/pdf-accessibility-auto-tag-api/dcserviceslicensing.md'
                                    },
                                    {
                                        title: 'Usage Limits',
                                        path: '2.2.0/pdf-accessibility-auto-tag-api/dcserviceslicensing.md#usage-limits'
                                    }
                                ]
                            }
                        ]
