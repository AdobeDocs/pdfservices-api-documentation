...
Add dynamic behaviour to a table using [dynamic table columns constructs](src/pages/2.2.0/document-generation-api/dynamictableconstructs.md#dynamic-table-columns) to discard column or set of columns at runtime.

## Dynamic table columns
Discard a column or set of columns in a table from the final generated document as follows :

- [Discard column if empty](src/pages/2.2.0/document-generation-api/dynamictableconstructs.md#discard-column-if-empty).
- [Discard column if condition evaluates to true](src/pages/2.2.0/document-generation-api/dynamictableconstructs.md#discard-column-if-condition-evaluates-to-true).
...
```
![Adding discard-if-empty construct with boolean false/true along with the template tag to activate discard if empty feature for the corresponding column](src/pages/2.2.0/images/discard_column_if_empty.png)
...
![Header Row of Development Milestones table](src/pages/2.2.0/images/header_row1.png)

![Header Row of Conversion tracking table](src/pages/2.2.0/images/header_row2.png)

![Development Milestones table without header row](src/pages/2.2.0/images/without_header_row.png)
...
![Added discard-if(expr(**condition**)) construct along with the template tag to activate discard if feature for the corresponding column](src/pages/2.2.0/images/discard_if_condition_true.png)
