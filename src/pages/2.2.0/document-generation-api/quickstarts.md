...
application. <br/>
To learn more about the Document Generation, read [Overview](src/pages/2.2.0/document-generation-api/index.md)
...
![Document template with heading and template tags](src/pages/2.2.0/images/design_document_templates.gif)
...
Learn more about our [Word Add-in](src/pages/2.2.0/document-generation-api/wordaddin.md#add-in-demo).
...
Learn more about [Template Tags](src/pages/2.2.0/document-generation-api/templatetags.md).
...
Alternatively, you can use our offering through [PDF Services SDK](src/pages/2.2.0/pdf-services-api#sdk).

<InlineAlert slots="text"/>

To get started with PDF Services SDK, refer [Quickstarts](src/pages/2.2.0/pdf-services-api).

<br/>

<InlineAlert slots="text"/>

Please allow-list the following hostnames before using Adobe PDF Services SDK:<ul><li>ims-na1.adobelogin.com</li><li>pdf-services.adobe.io (for versions 3.x.x)</li><li>cpf-ue1.adobe.io (for versions 2.x.x)</li><li>senseicore-ue1.adobe.io (for versions below 1.x.x)</li></ul>
...
![Document template with template tags being replaced by actual values](src/pages/2.2.0/images/generate_document.gif)


#### Generate PDF or Word document (with [Fragments](src/pages/2.2.0/document-generation-api/fragments.md))
