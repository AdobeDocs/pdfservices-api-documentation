...
![Samples directory structure Java](src/pages/2.2.0/images/samplefilesjava.png)
...
4.  Add the [Authentication](src/pages/2.2.0/pdf-services-api/index.md#authentication) details as described above.

![Adobe PDF Services SDK On Maven](src/pages/2.2.0/images/maven.png)
...
![Adobe PDF Services SDK on Nuget](src/pages/2.2.0/images/nuget.png)
...
![Adobe PDF Services SDK on NPM JS](src/pages/2.2.0/images/node.png)
...
3.  Test the sample code on the command line.
4.  Refer to the [HowTos](src/pages/2.2.0/pdf-services-api/howtos) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
...
4.  Test the sample code on the command line.
5.  Refer to the [HowTos](src/pages/2.2.0/pdf-services-api/howtos) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
...
![Adobe PDF Services SDK on Pypi](src/pages/2.2.0/images/python2.png)
