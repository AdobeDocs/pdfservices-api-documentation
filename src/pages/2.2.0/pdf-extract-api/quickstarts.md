...
4.  Add the [Authentication](src/pages/2.2.0/pdf-extract-api/index.md#authentication) details as described above.
...
3.  Test the sample code on the command line.
4.  Refer to the [How Tos](src/pages/2.2.0/pdf-extract-api/howtos) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
...
4.  Test the sample code on the command line.
5.  Refer to the [How Tos](src/pages/2.2.0/pdf-extract-api/howtos) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
