...
| Change | Description                                                            |
| ------ | ---------------------------------------------------------------------- |
| New | Deprecation messaging for PDF Embed API legacy viewer. Refer the [migration guide](src/pages/pdf-embed-api/modernviewer.md).
