...
![Selecting Site Title as DC SDK PDF Viewer Metrics in AEM Suite](src/pages/images/aemsuite.png)
...
![Selecting Processing Rules from AEM Edit Settings Menu](src/pages/images/aemeditsettingsmenu.png)
...
![Setting up AEM Processing Rules on event dimensions and events](src/pages/images/aemprocessingrules.png)
...
![AEM Dim Map with dimension variable and incoming event attribute field set](src/pages/images/aemdimmap.png)
...
![AEM Section 3 with event variable and incoming event attribute field set](src/pages/images/aemsection3.png)
...
![AEM Report with number of page views metric](src/pages/images/aemreport.png)
...
> **Note:** PDF analytics can only be collected in Google Analytics 4 property.
...
![Configure in GA4](src/pages/images/ga-create-dimension.png)
...
![Configure in GA4](src/pages/images/ga-custom-dimension.png)
...
![View sample exploration in GA4](src/pages/images/ga-page-view-2.png)

> **Note:** If your website subscribes to both Adobe Analytics and Google Analytics, 
...
To know more about the setup steps, see the sections [Adobe Analytics](src/pages/pdf-embed-api/howtodata.md#adobe-analytics) and [Google Analytics](src/pages/pdf-embed-api/howtodata.md#google-analytics).
...
> **Note:** -   If annotation APIs are not enabled, the event data contains the type of annotation on which the event gets triggered.
