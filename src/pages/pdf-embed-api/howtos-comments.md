...
![Annotation Tools like save button, adding sticky notes, text formatting menu and popover menu](src/pages/images/annotstoolsoverview.png)

![Comment Pane with features to add comments, reply to a comment, add a note with comment and delete comments](src/pages/images/commentpane.png)
...
![Add Text Menu with option to style font and delete](src/pages/images/addtext-menu.png)
...
![Sticky Note with option to change color and delete](src/pages/images/stickynote1.png)
...
![Text Selection with strikethrough](src/pages/images/textselectiontool.png)
...
![Context Menu with text styling options available](src/pages/images/contextmenu.png)
...
![Highlight Menu with option to change color and delete](src/pages/images/highlight-menu.png)
...
![Drawing Menu with option to change color of marker and delete](src/pages/images/drawing-menu.png)
...
![Eraser to erase drawing](src/pages/images/eraser.png)
...
![Undo Redo button on top right toolbar](src/pages/images/undo-redo.png)
...
![Select and pan option](src/pages/images/select-pan.png)
...
> **Note:** When only `enableAnnotationAPIs` is *true*, adding or updating
...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| context          | The context that determines the meaning of the JSON as an annotation. The annotation MUST have these two values in the context parameter:

[https://www.w3.org/ns/anno.jsonld](https://www.w3.org/ns/anno.jsonld),

[https://comments.acrobat.com/ns/anno.jsonld](https://comments.acrobat.com/ns/anno.jsonld)                                                                                                                                                                                                  | Yes       |
...
| stylesheet.value | This specifies the font size and color as a valid CSS JSON. This parameter is applicable only in case of freehand text annotations.
...
\<ul\><li>English: Helvetica</li><li>Chinese Simplified: Adobe Song Std L</li><li>Chinese Traditional: Kozuka Mincho Pr6N R</li><li>Japanese: Kozuka Mincho Pr6N R</li><li>Korean: Adobe Myungjo Std M</li><li>Other languages: Helvetica</li>\</ul\> | No        |
...
| selector.subtype     | The type of annotation. Permissible values include:

\<ul\><li>_note_</li><li>_highlight_</li><li>_shape_</li><li>_underline_</li><li>_strikeout_</li><li>_freetext_</li>\</ul\>                                                                                                                                                                                                                                         | Yes                                               |
...
> **Note:** When you enabled the annotation APIs, you must pass a PDF ID in the
...
> **Note:** If `includePDFAnnotations` is set to *true*, then any existing
...
> **Note:** You can update the `boundingBox` parameter only for note, add text and
...
For details, see [Annotation events](src/pages/pdf-embed-api/howtodata.md#annotation-events)
...
![Drawing Tools with optin to showToolbar and showCommentsPanel](src/pages/images/drawingtools1.png)
...
> **Note:** You can set and pass these flags to either `setConfig` or
...
> **Note:** [Working code samples reside in Github.](https://www.adobe.com/go/pdfembedapi_samples)
