...
![View SDK Playground with customization tools such as annotation, download etc and generate code button on the left](src/pages/images/playground.png)
...
![Continous Mode](src/pages/images/continuous-mode.png)

**Single page view mode**

![Single Page Mode](src/pages/images/single-page-mode.png)
...
[Menu and tool options](src/pages/pdf-embed-api/howtos-ui.md#menu-and-tool-options).
...
![Go To Page Dialog](src/pages/images/goto-page.png)
