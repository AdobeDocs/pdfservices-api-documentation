...
![Options for Customising User Interface using undo-redo, annotation tools, navigation, zoom etc](src/pages/images/ui.png)
...
| showAnnotationTools | *true*                         | If *true*, tools such as add text, sticky note, highlight, and so on appear in the quick tools menu on the left-hand side in full window embed mode. For more details, see [Comments and Markup](src/pages/pdf-embed-api/howtos-comments.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| defaultViewMode     | ""                             | This variable takes a string value of "**FIT\_WIDTH**", "**FIT\_PAGE**", "**TWO\_COLUMN**" or "**TWO\_COLUMN\_FIT\_PAGE**". 
...
In addition to these, there are two other view modes which are supported only in mobile browsers: 
 ...
 2. **SINGLE\_PAGE**: This mode displays only a single document page at a time and doesn’t show any adjoining page. Users can use the swipe gesture to navigate to other pages which will be displayed one at a time. |
...
For details, see [Comments and Markup](src/pages/pdf-embed-api/howtos-comments.md).
...
![User being referred to as guest](src/pages/images/userprofile-new.png)

When the callback is registered, user annotations are associated with
the corresponding username.

![User being referred with correct username](src/pages/images/userprofile1.png)
...
> **Note:** Previously, the default implementation of these user preferences was
...
> **Note:** A user cannot add comments or edit PDF files that are secure,
...
![Generic Error Message](src/pages/images/fail.png)
...
![File Modified message](src/pages/images/file-modified.png)
...
> **Note:** While you can specify additional options to control the status
...
![Get Latest Version message](src/pages/images/getlatest.png)
...
![Conflict On Save message](src/pages/images/saveconflict.png)
...
> **Note:** The document search option is not available in UI when search APIs are enabled.
...
> **Note:** Find the working code sample for search and zoom APIs
[here](https://www.adobe.com/go/pdfembedapi_samples) under
...
> **Note:** Find the working code sample
[here](https://www.adobe.com/go/pdfembedapi_samples) under
...
> **Note:** Navigation will not work if the specified page number exceeds the PDF
