...
> **Note:** As of April 2023, the legacy viewer is no longer available. All requests to it will load the new modern PDF viewer. The documentation below will be useful for developers needing to migrate to the modern viewing experience.
...
![Full window embed mode in legacy viewer](src/pages/images/fullwindow-legacy.png)
...
![Full window embed mode in legacy viewer](src/pages/images/fullwindow1.png)

## Sized container embed mode

### Sized container embed mode in legacy viewer

![Sized container embed mode in legacy viewer](src/pages/images/sized-legacy.png)
...
![Sized container embed mode in modern viewer](src/pages/images/sized-new.png)
...
![Sized container embed mode in modern viewer](src/pages/images/sized-full.png)

## In-line embed mode

### In-line embed mode in legacy viewer

![In-line embed mode in legacy viewer](src/pages/images/inline-legacy.png)

### In-line embed mode in modern viewer

![In-line embed mode in modern viewer](src/pages/images/inline-search.png)

## Lightbox embed mode

### Lightbox embed mode in legacy viewer

![Lightbox embed mode in legacy viewer](src/pages/images/lightbox-legacy.png)
...
![Lightbox embed mode in modern viewer](src/pages/images/lightboxscreen.png)
