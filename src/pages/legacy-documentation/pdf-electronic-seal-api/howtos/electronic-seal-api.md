...
> **Note:** Long Term Validation (LTV) information of Timestamp Certificates (if using Trusted Timestamping) is embedded in the PDF document only if Document Level Permission is set as FORM_FILLING or FORM_FILLING_AND_ANNOTATIONS.


### TSP Credential Information (_cscCredentialOptions_) : **Required**

TSP parameters encapsulate the sealer's [certificate credential](src/pages/legacy-documentation/pdf-electronic-seal-api/gettingstarted.md#step-1-procure-digital-certificate-credentials) as well as the associated authentication and authorization data.
...
* **TSP Name**  (*providerName*) : **Required** : Specifies the name of the Trust Service Provider used to generate the certificate. Presently, only TSPs supporting the OAuth 2.0 client credential authorization flow are supported. The table below provides the provider name mapping for each supported Trust Service Provider.
  ![TSP Name Mapping](src/pages/legacy-documentation/images/provider-mapping-ss.png)
...
TSA parameters encapsulate the [timestamping URL and credentials](src/pages/legacy-documentation/pdf-electronic-seal-api/gettingstarted.md#step-2-optional-procure-timestamping-url-and-credentials).
...
* **Display Options**  (*displayOptions*): Specifies the information to display in the seal. NAME and LABELS are the default values.
    ...
    * **NAME**: Specifies that the certificate owner's name should be displayed.
      ![Display Options](src/pages/legacy-documentation/images/name-ss.png)
    * **DATE**: Specifies that the sealing date/time should be displayed. This value should not be mistaken for a signed timestamp from a timestamp authority.
      ![Display Options](src/pages/legacy-documentation/images/date-ss.png)
    * **DISTINGUISHED_NAME**: Specifies that the distinguished name information from the digital certificate should be displayed.
      ![Display Options](src/pages/legacy-documentation/images/dn-ss.png)
    * **LABELS**: Specifies that text labels should be displayed.
      ![Display Options](src/pages/legacy-documentation/images/labels-ss.png)
    * **SEAL_IMAGE**: Specifies the seal image should be displayed.
      ![Display Options](src/pages/legacy-documentation/images/seal2-ss.png)
      ...
      ![Display Options](src/pages/legacy-documentation/images/trefoil-ss.png)
...
> **Note:** Support of Trusted Timestamping and Document Level Permissions is only available through REST APIs and Java SDK.
