...
![TSP Token Generation](src/pages/legacy-documentation/images/cert.png)
...
2. The supported TSAs are listed [here](src/pages/legacy-documentation/index.md#supported-timestamping-authorities). If support for any other TSA is required, reach out to us through customer support.
...
![TSP Token Generation](src/pages/legacy-documentation/images/tsp-token.png)
...
![Seal Workflow](src/pages/legacy-documentation/images/seal-flow.png)
...
You can read more about the API in detail [here](src/pages/apis/index.md#operation/asset.uploadpresignedurl).
...
> **Note:** For PDF Electronic Seal API, you can specify an optional seal image i.e. a logo/watermark/background image to be used as part of the seal's appearance. Step 4 can be repeated for uploading this seal image.
...
For creating the job, please refer to the corresponding API spec for the particular [PDF Operation](src/pages/apis/index.md).
...
You can read more about the API in detail [here](src/pages/apis/index.md#operation/pdfoperations.electronicseal.jobstatus).
...
You can read more about the API in detail [here](src/pages/apis/index.md#operation/asset.get).
...
4.  Add the [Authentication](src/pages/legacy-documentation/pdf-electronic-seal-api/index.md#authentication) details as described above.
...
![Adobe PDF Services SDK on Nuget](src/pages/legacy-documentation/images/nuget-free-tier.png)
...
![Adobe PDF Services SDK on NPM JS](src/pages/legacy-documentation/images/node-free-tier.png)
