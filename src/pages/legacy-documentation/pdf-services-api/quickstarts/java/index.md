...
![Sign in](src/pages/legacy-documentation/pdf-services-api/quickstarts/java/shot1.png)
...
![Project setup](src/pages/legacy-documentation/pdf-services-api/quickstarts/java/shot2-spc.png)

6) After your credentials are created, they are automatically downloaded:

![alt](src/pages/legacy-documentation/pdf-services-api/quickstarts/java/shot3-spc.png)
...
![alt](src/pages/legacy-documentation/pdf-services-api/quickstarts/java/shot5-spc.png)
...
![Example running in the command line](src/pages/legacy-documentation/pdf-services-api/quickstarts/java/shot9.png)
