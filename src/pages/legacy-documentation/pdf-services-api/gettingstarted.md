...
> **Note:** During the credential creation process you'll be asked whether you'd like a **Personalized Code Sample Download**. Choosing *Personalized* preconfigures the samples with your credential and removes a few steps from your development setup process.
...
You can read more about the API in detail [here](src/pages/apis/index.md#operation/pdfoperations.compresspdf.jobstatus).
...
4.  Add the [Authentication](src/pages/legacy-documentation/pdf-services-api/index.md#authentication) details as described above.
...
![Check Usage](src/pages/legacy-documentation/pdf-services-api/shot1.png)
...
![Check Usage Popup](src/pages/legacy-documentation/pdf-services-api/shot2.png)

<br />

4. Select the time period for which you want to check the usage and click on `Generate Report` button :

![Time period selection](src/pages/legacy-documentation/pdf-services-api/shot3.png)
...
![Usage](src/pages/legacy-documentation/pdf-services-api/shot4.png)
...
![Client ID](src/pages/legacy-documentation/pdf-services-api/shot6.png)
