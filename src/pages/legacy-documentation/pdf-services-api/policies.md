...
release of a newer Major/Minor Version; that is a Major.Minor.X
version reaches its end of life 1 year after the next Major/Minor
Release](src/pages/legacy-documentation/images/support1.png)
...
the [Documentation Library](src/pages/legacy-documentation/pdf-services-api/releasenotes.md#archived-documentation) for links.
