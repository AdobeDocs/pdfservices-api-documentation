...
[Version - Support policy](src/pages/legacy-documentation/pdf-services-api/policies.md).
...
![Previous Release tags with release notes and links to the assets](src/pages/legacy-documentation/images/prevrelease.png)
...
| Change  | Language | Description                                                                                                                                                                                                                            |
|---------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Changed | Java     | Added support for document level permissions and trusted timestamping (using [supported TSAs](src/pages/legacy-documentation/pdf-electronic-seal-api/index.md#supported-timestamping-authorities)) in java sdk for [PDF Electronic Seal API](src/pages/legacy-documentation/pdf-electronic-seal-api/index.md). |
...
| Change | Language | Description                                                                                                              |
|--------|----------|--------------------------------------------------------------------------------------------------------------------------|
| New    | API     | Added support for document level permissions and trusted timestamping (using [supported TSAs](src/pages/legacy-documentation/pdf-electronic-seal-api/index.md#supported-timestamping-authorities)) in [PDF Electronic Seal API](src/pages/legacy-documentation/pdf-electronic-seal-api/index.md).   |
| New    | API     | Added support for [External Storage](src/pages/legacy-documentation/pdf-services-api/howtos/pdf-external-storage-sol.md) in all the operations **except** Extract PDF, Split PDF, PDF Electronic Seal and Auto-Tag PDF. |
...
| Change | Language | Description                                                                                                              |
|--------|----------|--------------------------------------------------------------------------------------------------------------------------|
| New    | API     | Added support for [External Storage](src/pages/legacy-documentation/pdf-services-api/howtos/pdf-external-storage-sol.md) in Document Generation API.   |
...
| Change  | Language | Description                                                                                                                  |
|---------|----------|------------------------------------------------------------------------------------------------------------------------------|
| New     | Java,NodeJS,.NET      | Adding support for [inline images](src/pages/legacy-documentation/document-generation-api/inlineimages.md#) feature.                                     |
| New     | Java,NodeJS,.NET      | Adding support for additional constructs in [fragments](src/pages/legacy-documentation/document-generation-api/fragments.md#Other-supported-constructs). |
| Changed | Java,NodeJS,.NET      | Adding support for prefix in [text tags](src/pages/legacy-documentation/document-generation-api/templatetags.md#Placeholder-Variables).                  |
...
| Change  | Language            | Description                                                                                                                                                   |
| ------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------|
| New     | All                 | Adding support for [fragments](src/pages/legacy-documentation/document-generation-api/fragments.md#) feature.                                                                             |
...
| ------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| New     | All      | Adding support for [fragments](src/pages/legacy-documentation/document-generation-api/fragments.md#) feature.                                                                                        |
| Changed     | All      | Adding support to add [images](src/pages/legacy-documentation/document-generation-api/templatetags.md#images) (only base64 encoded image data was supported initially) through publicly accessible URLs.     |
| Changed     | All      | Adding support for primitive type [list](src/pages/legacy-documentation/document-generation-api/templatetags.md#lists)

### Adobe Document Generation Server Side Release (14 December, 2021; server side release)

| Change  | Language | Description                                                                                                                                                              |
| ------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| New     | All      | Adding support for additional tags (<strong\> and <em\>) in [styling and formatting](src/pages/legacy-documentation/document-generation-api/stylingformattingtags.md#apply-styling-and-formatting) feature.                                                                               |
| New     | All      | Support for [dynamic table constructs](src/pages/legacy-documentation/document-generation-api/complextableconstructs.md).     |
...
| Change  | Language | Description                                                                                                                                                   |
| ------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| New     | All      | HTML [styling and formatting](src/pages/legacy-documentation/document-generation-api/stylingformattingtags.md#apply-styling-and-formatting) support in json data.                                                                               |
| New     | All      | Support for [horizontal tables](src/pages/legacy-documentation/document-generation-api/templatetags.md#dynamically-expand-table-rows-or-columns).     |
