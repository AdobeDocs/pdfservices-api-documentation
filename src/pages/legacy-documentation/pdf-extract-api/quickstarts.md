...
> **Note:** Please allow-list the following hostnames before using Adobe PDF Services SDK:\<ul\><li>ims-na1.adobelogin.com</li><li>cpf-ue1.adobe.io</li>\</ul\>
...
> **Note:** Command line execution is not mandatory. You can import the samples Maven project into your preferred IDE (e.g. IntelliJ/Eclipse) and run the samples from there.
...
![Samples directory structure Java](src/pages/legacy-documentation/images/samplefilesjava.png)
...
4.  Add the [Authentication](src/pages/legacy-documentation/pdf-extract-api/index.md#authentication) details as described above.

![Adobe PDF Services SDK on Maven](src/pages/legacy-documentation/images/maven.png)
...
Once you complete the [Getting Credentials](src/pages/legacy-documentation/pdf-extract-api/quickstarts/index.md#getting-credentials), you will receive a zip file with content whose structure varies based on whether you opted to download personalized code samples. The zip file structures are as follows:
...
1.  Go to [NuGet package](https://www.adobe.com/go/pdftoolsapi_net_nuget).
2.  Download the latest package.

![Adobe PDF Services SDK on Nuget](src/pages/legacy-documentation/images/nuget.png)
...
1.  Go to [npm package](https://www.npmjs.com/package/@adobe/pdfservices-node-sdk)
2.  Download the latest package.

![Adobe PDF Services SDK on NPM JS](src/pages/legacy-documentation/images/node.png)
...
3.  Test the sample code on the command line.
4.  Refer to the [How Tos](src/pages/legacy-documentation/pdf-extract-api/howtos/index.md) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
...
4.  Test the sample code on the command line.
5.  Refer to the [How Tos](src/pages/legacy-documentation/pdf-extract-api/howtos/index.md) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
