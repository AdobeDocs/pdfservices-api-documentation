...
1) To begin, open your browser to [Get credentials](https://acrobatservices.adobe.com/dc-integration-creation-app-cdn/main.html?api=pdf-extract-api). If you are not already logged in to Adobe.com, you will need to sign in or create a new user. Using a personal email account is recommend and not a federated ID.

![Sign in](src/pages/legacy-documentation/pdf-extract-api/quickstarts/nodejs/shot1.png)
...
![Project setup](src/pages/legacy-documentation/pdf-extract-api/quickstarts/nodejs/shot2-spc.png)

6) After your credentials are created, they are automatically downloaded:

![alt](src/pages/legacy-documentation/pdf-extract-api/quickstarts/nodejs/shot3-spc.png)
...
![alt](src/pages/legacy-documentation/pdf-extract-api/quickstarts/nodejs/shot5-spc.png)
...
![alt](src/pages/legacy-documentation/pdf-extract-api/quickstarts/nodejs/shot7.png)

4) Install the Adobe PDF Services Node.js SDK by typing `npm install --save @adobe/pdfservices-node-sdk` at the command line.

![alt](src/pages/legacy-documentation/pdf-extract-api/quickstarts/nodejs/shot8.png)
...
![Example running at the command line](src/pages/legacy-documentation/pdf-extract-api/quickstarts/nodejs/shot9.png)
