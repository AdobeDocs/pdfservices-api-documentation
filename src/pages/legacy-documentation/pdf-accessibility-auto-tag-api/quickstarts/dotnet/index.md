...
![Sign in](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/dotnet/shot1.png)
...
![Project setup](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/dotnet/shot2-spc.png)

6) After your credentials are created, they are automatically  downloaded:

![alt](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/dotnet/shot3-spc.png)
...
![alt](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/dotnet/shot5-spc.png)
...
![Example running in the command line](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/dotnet/shot9-ga.png)
