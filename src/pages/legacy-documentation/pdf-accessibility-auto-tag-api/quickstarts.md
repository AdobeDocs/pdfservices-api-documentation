...
The PDF Accessibility Auto-Tag API is currently available as Early Access. To request access, [Contact Us](https://adobe.com/go/accessibility_early_access_form). Once you receive confirmation that you’ve been given access, proceed to the next step to [Get API credentials](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/index.md#get-api-credentials).
...
Once you complete the [Get API credentials](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/index.md#get-api-credentials), a zip file automatically downloads that contains content whose structure varies based on whether you opted to download personalized code samples. The zip file structures are as follows:
...
3. In the top-level directory of your samples, find and replace following files with the one present in the downloaded zip file from [Get API credentials](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/quickstarts/index.md#get-api-credentials) step:
