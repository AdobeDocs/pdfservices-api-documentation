...
4.  Add the [Authentication](src/pages/legacy-documentation/pdf-accessibility-auto-tag-api/index.md#authentication) details as described above.
...
> **Note:** Other sample programs in the SDK let you try out API options including generating a tagging report, and shifting headings so that the document title is only H1.
