...
The [samples and documentation](accessibility-auto-tag-api.md/#generate-tagged-pdf-from-a-pdf) should get you quickly up and running with PDF Accessibility Auto-Tag capabilities in the [PDFServices SDK](src/pages/legacy-documentation/pdf-services-api/index.md) including:
