...
Generate mobile-optimized PDFs through Document Generation using [PDF Services Beta SDK](src/pages/legacy-documentation/document-generation-api/beta.md#beta-sdk) and [Beta API](https://documentcloud.adobe.com/document-services/beta.html#post-documentGeneration) The generated PDF is optimized
