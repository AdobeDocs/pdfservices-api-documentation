...
{{localityDetails}}",
  "streetDetails":"<span style=\"color: 0000FF;\">{{addressline1}}
...
> **Note:** To resolve the value of nested fragment like `streetDetails` above, the same object containing the parent fragment i.e. `addressDetails` will be looked up. This is how the nested fragments are resolved.


> **Note:** If there are name collisions in the fragment keys within multiple objects, the first object (containing the key) in the list, will be used to resolve it.
...
![Address Input fragment](src/pages/legacy-documentation/images/address-input.png)

The output document generated will look like:

![Output of address fragment in document](src/pages/legacy-documentation/images/address-output.png)

Similarly,  the `fullname` fragment can be used like this in the word document template file.

![Name Input fragment](src/pages/legacy-documentation/images/name-input.png)

And the output document generated will look like:

![Output of name fragment in document](src/pages/legacy-documentation/images/name-output.png)
...
![Output of fragment with condition in document](src/pages/legacy-documentation/images/fragments-condition.png)
...
![Output of fragment with optional value in document](src/pages/legacy-documentation/images/fragments-optional.png)
...
![Output of fragment with default value in document](src/pages/legacy-documentation/images/fragments-default.png)
...
![Output of fragment with prefix in document](src/pages/legacy-documentation/images/fragments-prefix.png)
