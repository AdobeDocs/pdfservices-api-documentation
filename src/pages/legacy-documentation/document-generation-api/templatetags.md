...
Process](src/pages/legacy-documentation/document-generation-api/index.md#document-generation-process) , the Document
...
document.\<br/\>
For more simplified styling and formatting for the placeholder tag from the input json data, please refer [styling and formatting](src/pages/legacy-documentation/document-generation-api/stylingformattingtags.md) section:
...
![Placeholder tags being replaced by values](src/pages/legacy-documentation/images/placeholder-basic.png)
...
![Placeholder tags with default value set](src/pages/legacy-documentation/images/placeholder-default.png)
...
![Placeholder tags with optional image set](src/pages/legacy-documentation/images/placeholder-optional.png)
...
![Placeholder tags with prefix image set](src/pages/legacy-documentation/images/placeholder-prefix.png)
## Images
...
![Initial rendering of the image tag](src/pages/legacy-documentation/images/image-tag-initial.png)

Add the alt text to the image as per the specified format.

![Adding alternative text for the image](src/pages/legacy-documentation/images/image-alt-text.png)

The image placeholder will be replaced by the image data in
the output document.

![Image placeholder replaced by the image data](src/pages/legacy-documentation/images/image-tag-final.png)

<InlineAlert slots="text"/>

Image can also be inserted using the html `<img/>` tag. Please refer [Inline Images](src/pages/legacy-documentation/document-generation-api/inlineimages.md) to learn more about this.
...
![Showing an paragraph based on a condition](src/pages/legacy-documentation/images/conditional-section.png)
...
![Showing a text inside a paragraph based on a condition](src/pages/legacy-documentation/images/conditional-phrase.png)
...
![Sample for HTML Table insertion](src/pages/legacy-documentation/images/html-table-output.png)
...
![Table created with column headers and template tags for each subsequent rows](src/pages/legacy-documentation/images/table.png)

Table rows are dynamically populated in the output document by repeating
over the specified array of objects.

![Table with template tags replaced with actual values in the rows](src/pages/legacy-documentation/images/table-result.png)

<InlineAlert slots="text"/>

Please visit [Complex Table Constructs](src/pages/legacy-documentation/document-generation-api/complextableconstructs.md) to learn about advanced
...
![Template tag items are replaced by numbered list](src/pages/legacy-documentation/images/numbered-list.png)
...
![Template tag items are replaced by bullet list](src/pages/legacy-documentation/images/bullet-list.png)
...
![Template tag items are replaced by numbered or bullet list](src/pages/legacy-documentation/images/simple-lists.png)
...
![Performing simple arithmetic to show revenue-expenditure](src/pages/legacy-documentation/images/arithmetic.png)
...
![Performing simple arithmetic to show aggregation](src/pages/legacy-documentation/images/aggregation.png)
