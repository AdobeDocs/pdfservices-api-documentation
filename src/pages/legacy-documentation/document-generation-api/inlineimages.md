...
```
![Representation of sample json data](src/pages/legacy-documentation/images/inline-image-json.png)
...
![Adding inline image in the document through json data using image <img\> tag](src/pages/legacy-documentation/images/inline-image.png)
