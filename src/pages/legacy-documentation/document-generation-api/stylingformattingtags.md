...
- Create [Hyperlinks](src/pages/legacy-documentation/document-generation-api/hyperlink.md).

- Create [Inline Images](src/pages/legacy-documentation/document-generation-api/inlineimages.md).
...
![Sending text styling constructs, provide styling for the output document in json file. Adobe Document Generation API analyses the json data and inserts styled text in output documents](src/pages/legacy-documentation/images/consolidated-styling-formatting.png)
...
```
![Styling Tags Sample with style for font-size, font-weight and font-style attribute added to span tag](src/pages/legacy-documentation/images/styling-attributes-json-rep.png)

![Styling Tags output when style for font-size, font-weight and font-style attribute was added to span tag](src/pages/legacy-documentation/images/styling-attributes-output.png)
...
```
![Styling Tags Sample with style for font-size attribute added to span tag](src/pages/legacy-documentation/images/styling-tags-json-rep.png)

![Styling Tags output when style for font-size attribute was added to span tag](src/pages/legacy-documentation/images/styling-tags-output.png)
...
```
![Sample_for_P_tag](src/pages/legacy-documentation/images/sample-for-p-tags.png)
![Sample for P tag_output](src/pages/legacy-documentation/images/sample-for-ptag-formatted.png)
