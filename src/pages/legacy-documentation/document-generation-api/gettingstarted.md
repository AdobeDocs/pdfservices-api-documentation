...
To learn more about the Document Generation, read [Overview](src/pages/legacy-documentation/document-generation-api/index.md)
...
![Document template with heading and template tags](src/pages/legacy-documentation/images/design-document-templates.gif)
...
> **Note:** Learn more about our [Word Add-in](src/pages/legacy-documentation/document-generation-api/wordaddin.md).
...
> **Note:** Learn more about [Template Tags](src/pages/legacy-documentation/document-generation-api/templatetags.md).
...
You can use our cloud based [REST API](src/pages/apis/index.md#tag/Document-Generation) to generate documents.

> **Note:** Before you begin with the REST API, refer [How To Get Started](src/pages/legacy-documentation/pdf-services-api/howtos/api-usage.md) to learn more about generating the required credentials and invoking the APIs.
...
To learn more, please visit [External Storage for Adobe PDF Services APIs](src/pages/legacy-documentation/pdf-services-api/howtos/pdf-external-storage-sol.md).


**3.3. PDF Services SDK** 


Alternatively, you can use our offering through [PDF Services SDK](src/pages/legacy-documentation/pdf-services-api/gettingstarted.md#sdk).

> **Note:** To get started with PDF Services SDK, refer [Quickstarts](src/pages/legacy-documentation/document-generation-api/quickstarts.md).
...
Please refer the [API usage guide](src/pages/legacy-documentation/pdf-services-api/howtos/api-usage.md) to understand how to use our APIs.
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Document-Generation
...
![Document template with template tags being replaced by actual values](src/pages/legacy-documentation/images/generate-document.gif)


#### Generate PDF or Word document (with [Fragments](src/pages/legacy-documentation/document-generation-api/fragments.md))
