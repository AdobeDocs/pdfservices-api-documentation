...
![Document Generation Process : Request consisting of a docx file and a json is sent to Adobe Document Generation API by client application. Adobe Document Generation API returns a document with these template tags replaced by the actual data as per the json.](src/pages/legacy-documentation/images/docgen-process.jpeg)
...
To learn more, please visit [Template Tags](src/pages/legacy-documentation/document-generation-api/templatetags.md)
...
[Document Generation
API](../../apis/index.md#tag/Document-Generation)
...
To learn more, please visit [QuickStarts](src/pages/legacy-documentation/document-generation-api/quickstarts.md)
