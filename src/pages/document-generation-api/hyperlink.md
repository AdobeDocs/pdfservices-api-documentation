...
```
![Added hyperlink in the document through json data using anchor <a\> tag](src/pages/images/anchor-tag-sample.png)

![Formatted output in the document when anchor tag is resolved](src/pages/images/anchor-tag1.png)
