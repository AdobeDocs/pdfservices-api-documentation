...
![Address Input fragment](src/pages/images/address-input.png)

The output document generated will look like:

![Output of address fragment in document](src/pages/images/address-output.png)

Similarly,  the `fullname` fragment can be used like this in the word document template file.

![Name Input fragment](src/pages/images/name-input.png)

And the output document generated will look like:

![Output of name fragment in document](src/pages/images/name-output.png)
...
![Output of fragment with condition in document](src/pages/images/fragments-condition.png)
...
![Output of fragment with optional value in document](src/pages/images/fragments-optional.png)
...
![Output of fragment with default value in document](src/pages/images/fragments-default.png)
...
![Output of fragment with prefix in document](src/pages/images/fragments-prefix.png)
