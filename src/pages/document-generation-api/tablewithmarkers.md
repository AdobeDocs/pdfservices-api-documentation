...
![Table created with table start and end constructs](src/pages/images/table-tag-with-markers.png)
...
![Nested tables with table markers](src/pages/images/nested-tables.png)
...
> **Note:** - Nested Tables are only supported using the `Table Markers`.
...
![Table Markers With different context](src/pages/images/table-markers-context-input.png)
...
![Table Markers with different context output](src/pages/images/table-markers-context-output.png)

> **Note:** - If **eval** construct is not used with a condition, it is evaluated in the context of the current table being expanded.
...
![Vertical extension with table markers](src/pages/images/table-markers-vertical-extension.png)
...
![Horizontal extension with table markers](src/pages/images/table-markers-horizontal-extension.png)
...
![Discard if empty with table markers](src/pages/images/discard-if-empty-table-markers.png)
...
![Discard if with table markers](src/pages/images/discard-if-table-markers.png)
...
![Discard row if with table markers](src/pages/images/discard-row-if-table-markers.png)
...
![Discard row if with table markers](src/pages/images/discard-row-in-horizontal-table.png)
