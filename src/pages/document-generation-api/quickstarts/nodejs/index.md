...
![Sign in](src/pages/document-generation-api/quickstarts/nodejs/shot1.png)
...
![Project setup](src/pages/document-generation-api/quickstarts/nodejs/shot2-spc.png)

6) After your credentials are created, they are automatically downloaded:

![alt](src/pages/document-generation-api/quickstarts/nodejs/shot3-spc.png)
...
![alt](src/pages/document-generation-api/quickstarts/nodejs/shot5-spc.png)
...
![alt](src/pages/document-generation-api/quickstarts/nodejs/shot7.png)

4) Install the Adobe PDF Services Node.js SDK by typing `npm install --save @adobe/pdfservices-node-sdk` at the command line.

![alt](src/pages/document-generation-api/quickstarts/nodejs/shot8.png)
...
![Example of tokens](src/pages/document-generation-api/quickstarts/nodejs/shot10.png)
...
![Example running at the command line](src/pages/document-generation-api/quickstarts/nodejs/shot9.png)
