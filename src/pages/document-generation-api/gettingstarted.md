...
To learn more about the Document Generation, read [Overview](src/pages/document-generation-api/index.md)
...
![Document template with heading and template tags](src/pages/images/design-document-templates.gif)
...
> **Note:** Learn more about our [Word Add-in](src/pages/document-generation-api/wordaddin.md).
...
> **Note:** Learn more about [Template Tags](src/pages/document-generation-api/templatetags.md).
...
> **Note:** Before you begin with the REST API, refer [How To Get Started](src/pages/pdf-services-api/howtos/api-usage.md) to learn more about generating the required credentials and invoking the APIs.
...
To learn more, please visit [External Storage for Adobe PDF Services APIs](src/pages/pdf-services-api/howtos/pdf-external-storage-sol.md).


**3.3. PDF Services SDK** 


Alternatively, you can use our offering through [PDF Services SDK](src/pages/pdf-services-api/gettingstarted.md#sdk).

> **Note:** To get started with PDF Services SDK, refer [Quickstarts](src/pages/document-generation-api/quickstarts/index.md).
...
Please refer the [API usage guide](src/pages/pdf-services-api/howtos/api-usage.md) to understand how to use our APIs.
...
![Document template with template tags being replaced by actual values](src/pages/images/generate-document.gif)


#### Generate PDF or Word document (with [Fragments](src/pages/document-generation-api/fragments.md))
