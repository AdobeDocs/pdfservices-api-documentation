...
- Create [Hyperlinks](src/pages/document-generation-api/hyperlink.md).

- Create [Inline Images](src/pages/document-generation-api/inlineimages.md).
...
![Sending text styling constructs, provide styling for the output document in json file. Adobe Document Generation API analyses the json data and inserts styled text in output documents](src/pages/images/consolidated-styling-formatting.png)
...
```
![Styling Tags Sample with style for font-size, font-weight and font-style attribute added to span tag](src/pages/images/styling-attributes-json-rep.png)

![Styling Tags output when style for font-size, font-weight and font-style attribute was added to span tag](src/pages/images/styling-attributes-output.png)

## Inline images supported attributes

You may find documentation for using inline images [here](src/pages/document-generation-api/inlineimages.md).
...
```
![Formatting Inline images with height and width](src/pages/images/formatted-inline-image-height-and-width.png)
...
```json
{
  "Notes Section": "Has the Board of directors established a basic policy <span style=\"font-size: 14pt;\">regarding legal compliance \<b\><i>(hereinafter referred to as the Legal Compliance policy) </i>\</b\>\</span\><a href=\"http://www.samplewebsite.com/\">Board</a> in accordance to the institution's 

<u>corporate management policy</u> and disseminated it throughout the institution"
}
```
![Styling Tags Sample with style for font-size attribute added to span tag](src/pages/images/styling-tags-json-rep.png)

![Styling Tags output when style for font-size attribute was added to span tag](src/pages/images/styling-tags-output.png)
...
```
![Sample_for_P_tag](src/pages/images/sample-for-p-tags.png)
![Sample for P tag_output](src/pages/images/sample-for-ptag-formatted.png)

> **Note:** - `&nbsp` HTML entity is not supported in JSON for representing non-breaking space characters.
