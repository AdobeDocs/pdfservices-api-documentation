...
![Edit chart data in Excel](src/pages/overview/images/insert-chart-in-document.png)

> **Note:** Include only the chart data in the Excel sheet, omitting any additional text.
...
![Placeholder for line chart](src/pages/overview/images/line-chart-placeholder.png)

- Edit the chart data in the Excel by right click on chart and select "Edit Data in Excel".

![Edit chart data in Excel](src/pages/overview/images/excel-line-chart.png)
...
![Output of line chart in document](src/pages/overview/images/output-line-chart.png)
...
![Placeholder for column chart](src/pages/overview/images/column-chart-placeholder.png)

- Edit the chart data in the Excel by right click on chart and select "Edit Data in Excel".

![Edit chart data in Excel](src/pages/overview/images/excel-column-chart.png)
...
![Output of line chart in document](src/pages/overview/images/output-column-chart.png)
...
![Placeholder for pie chart](src/pages/overview/images/pie-chart-placeholder.png)

- Edit the chart data in the Excel by right click on chart and select "Edit Data in Excel".

![Edit chart data in Excel](src/pages/overview/images/excel-pie-chart.png)
...
![Output of pie chart in document](src/pages/overview/images/output-pie-chart.png)

> **Note:** - Do not use charts within repeating section tags.
