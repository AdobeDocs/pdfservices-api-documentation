...
![Sign in](src/pages/pdf-accessibility-auto-tag-api/quickstarts/nodejs/shot1.png)
...
![Project setup](src/pages/pdf-accessibility-auto-tag-api/quickstarts/nodejs/shot2-spc.png)

6) After your credentials are created, they are automatically downloaded:

![alt](src/pages/pdf-accessibility-auto-tag-api/quickstarts/nodejs/shot3-spc.png)
...
![alt](src/pages/pdf-accessibility-auto-tag-api/quickstarts/nodejs/shot5-spc.png)
...
![alt](src/pages/pdf-accessibility-auto-tag-api/quickstarts/nodejs/shot7.png)

4) Install the Adobe PDF Services Node.js SDK by typing `npm install --save @adobe/pdfservices-node-sdk` at the command line.

![alt](src/pages/pdf-accessibility-auto-tag-api/quickstarts/nodejs/shot8.png)
...
![Example running at the command line](src/pages/pdf-accessibility-auto-tag-api/quickstarts/nodejs/shot9-ga.png)
