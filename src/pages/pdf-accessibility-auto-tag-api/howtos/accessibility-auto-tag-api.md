...
- **Unprotected files:** The API supports files that are unprotected or where security restrictions allow editing of content. Files that are secured and do not allow editing of content will not be processed. If the password of a protected PDF is known, the permissions of the file can be modified using the PDF Services API as shown [here](src/pages/pdf-services-api/howtos/remove-protection.md).
...
See our public API Reference for [PDF Accessibility Auto-Tag API](src/pages/apis/index.md#tag/PDF-Accessibility-Auto-Tag).
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/PDF-Accessibility-Auto-Tag
