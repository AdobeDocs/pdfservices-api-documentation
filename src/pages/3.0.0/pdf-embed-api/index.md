...
![View SDK Playground with customization tools such as annotation, download etc and generate code button on the left](src/pages/3.0.0/images/playground.png)
...
![Print Unsupported Error in Firefox](src/pages/3.0.0/images/print_unsupported_FF.png)
...
![Continous Mode](src/pages/3.0.0/images/continuous_mode.png)

**Single page view mode**

![Single Page Mode](src/pages/3.0.0/images/single_page_mode.png)
...
[Menu and tool options](src/pages/3.0.0/pdf-embed-api/howtos_ui.md#menu-and-tool-options).
...
![Go To Page Dialog](src/pages/3.0.0/images/goto_page.png)
