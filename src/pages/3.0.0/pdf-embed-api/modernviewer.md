...
![Full window embed mode in legacy viewer](src/pages/3.0.0/images/fullwindow_legacy.png)
...
![Full window embed mode in legacy viewer](src/pages/3.0.0/images/fullwindow1.png)

## Sized container embed mode

### Sized container embed mode in legacy viewer

![Sized container embed mode in legacy viewer](src/pages/3.0.0/images/sized_legacy.png)
...
![Sized container embed mode in modern viewer](src/pages/3.0.0/images/sized_new.png)

<br/>

*Sized container in full screen mode*

![Sized container embed mode in modern viewer](src/pages/3.0.0/images/sized_full.png)

## In-line embed mode

### In-line embed mode in legacy viewer

![In-line embed mode in legacy viewer](src/pages/3.0.0/images/inline_legacy.png)

### In-line embed mode in modern viewer

![In-line embed mode in modern viewer](src/pages/3.0.0/images/inline_search.png)

## Lightbox embed mode

### Lightbox embed mode in legacy viewer

![Lightbox embed mode in legacy viewer](src/pages/3.0.0/images/lightbox_legacy.png)
...
![Lightbox embed mode in modern viewer](src/pages/3.0.0/images/lightboxscreen.png)
