...
| Change | Description                                                            |
| ------ | ---------------------------------------------------------------------- |
| New | Deprecation messaging for PDF Embed API legacy viewer. Refer the [migration guide](src/pages/3.0.0/pdf-embed-api/modernviewer.md).
...
| Change | Description                                                            |
| ------ | ---------------------------------------------------------------------- |
| New    | PDF Embed API is also available on the new <b>documentservices.adobe.com</b> subdomain. For sample usage, see the section [sample usage](src/pages/3.0.0/pdf-embed-api/index.md#copy-it-run-it). |
...
| Change | Description                                                            |
| ------ | ---------------------------------------------------------------------- |
| New    | Website developers can now integrate Google Analytics with PDF Embed API with only a few steps and collect PDF analytics. For more details, see the section [Google Analytics](src/pages/3.0.0/pdf-embed-api/howtodata.md#google-analytics).                         |
