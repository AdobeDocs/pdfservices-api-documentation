...
4.  Add the [Authentication](src/pages/3.0.0/pdf-services-api/index.md#authentication) details as described above.
...
3.  Test the sample code on the command line.
4.  Refer to the [HowTos](src/pages/3.0.0/pdf-services-api/howtos) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
...
4.  Test the sample code on the command line.
5.  Refer to the [HowTos](src/pages/3.0.0/pdf-services-api/howtos) for details about running samples. Additional details also reside in the [API documentation](https://www.adobe.com/go/pdfservices_python_docs).
...
![Adobe PDF Services SDK on Pypi](src/pages/3.0.0/images/python2.png)
