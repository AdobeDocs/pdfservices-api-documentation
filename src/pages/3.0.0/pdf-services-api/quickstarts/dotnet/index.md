...
![Sign in](src/pages/3.0.0/pdf-services-api/quickstarts/dotnet/shot1.png)
...
![Project setup](src/pages/3.0.0/pdf-services-api/quickstarts/dotnet/shot2.png)

6) After your credentials are created, they are automatically  downloaded:

![alt](src/pages/3.0.0/pdf-services-api/quickstarts/dotnet/shot3.png)
...
![alt](src/pages/3.0.0/pdf-services-api/quickstarts/dotnet/shot5.png)
...
![alt](src/pages/3.0.0/pdf-services-api/quickstarts/dotnet/shot6.png)
...
![Example running in the command line](src/pages/3.0.0/pdf-services-api/quickstarts/dotnet/shot9.png)
