...
Generate mobile-optimized PDFs through Document Generation using [PDF Services Beta SDK](src/pages/3.0.0/document-generation-api/beta.md#beta-sdk) and [Beta API](https://documentcloud.adobe.com/document-services/beta.html#post-documentGeneration) The generated PDF is optimized
