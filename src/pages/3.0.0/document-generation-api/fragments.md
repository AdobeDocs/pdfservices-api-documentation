...
![Address Input fragment](src/pages/3.0.0/images/address_input.png)

The output document generated will look like:

![Output of address fragment in document](src/pages/3.0.0/images/address_output.png)

Similarly,  the `fullname` fragment can be used like this in the word document template file.

![Name Input fragment](src/pages/3.0.0/images/name_input.png)

And the output document generated will look like:

![Output of name fragment in document](src/pages/3.0.0/images/name_output.png)
...
![Output of fragment with condition in document](src/pages/3.0.0/images/fragments-condition.png)
...
![Output of fragment with optional value in document](src/pages/3.0.0/images/fragments-optional.png)
...
![Output of fragment with default value in document](src/pages/3.0.0/images/fragments-default.png)
...
![Output of fragment with prefix in document](src/pages/3.0.0/images/fragments-prefix.png)
