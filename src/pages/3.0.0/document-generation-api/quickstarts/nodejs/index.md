...
![Sign in](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot1.png)
...
![Project setup](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot2.png)

6) After your credentials are created, they are automatically downloaded:

![alt](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot3.png)
...
![alt](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot5.png)
...
![alt](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot6.png)
...
![alt](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot7.png)

5) Install the Adobe PDF Services Node.js SDK by typing `npm install --save @adobe/pdfservices-node-sdk` at the command line.

![alt](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot8.png)
...
![Example of tokens](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot10.png)
...
![Example running at the command line](src/pages/3.0.0/document-generation-api/quickstarts/nodejs/shot9.png)
