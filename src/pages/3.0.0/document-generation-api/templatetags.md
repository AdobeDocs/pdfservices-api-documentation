...
Process](src/pages/3.0.0/document-generation-api/index.md#document-generation-process) , the Document
...
document.<br/>
For more simplified styling and formatting for the placeholder tag from the input json data, please refer [styling and formatting](src/pages/3.0.0/document-generation-api/stylingformattingtags.md) section:
...
![Placeholder tags being replaced by values](src/pages/3.0.0/images/placeholder_basic.png)
...
![Placeholder tags with default value set](src/pages/3.0.0/images/placeholder_default.png)
...
![Placeholder tags with optional image set](src/pages/3.0.0/images/placeholder_optional.png)
...
![Placeholder tags with prefix image set](src/pages/3.0.0/images/placeholder_prefix.png)
## Images
...
![Initial rendering of the image tag](src/pages/3.0.0/images/image_tag_initial.png)

Add the alt text to the image as per the specified format.

![Adding alternative text for the image](src/pages/3.0.0/images/image_alt_text.png)

The image placeholder will be replaced by the image data in
the output document.

![Image placeholder replaced by the image data](src/pages/3.0.0/images/image_tag_final.png)
...
![Table created with column headers and template tags for each subsequent rows](src/pages/3.0.0/images/table.png)

Table rows are dynamically populated in the output document by repeating
over the specified array of objects.

![Table with template tags replaced with actual values in the rows](src/pages/3.0.0/images/table_result.png)
...
![Table gets vertically extended as table rows are repeated](src/pages/3.0.0/images/vertical-extension1.png)
...
![Table gets horizontally extended as table columns are repeated](src/pages/3.0.0/images/horizontal-extension1.png)
...
![Template tag items are replaced by numbered list](src/pages/3.0.0/images/numbered_list.png)
...
![Template tag items are replaced by bullet list](src/pages/3.0.0/images/bullet_list.png)
...
![Template tag items are replaced by numbered or bullet list](src/pages/3.0.0/images/simple_lists.png)
...
![Showing an paragraph based on a condition](src/pages/3.0.0/images/conditional_section.png)
...
![Showing a text inside a paragraph based on a condition](src/pages/3.0.0/images/conditional_phrase.png)
...
![Performing simple arithmetic to show revenue-expenditure](src/pages/3.0.0/images/arithmetic.png)
...
![Performing simple arithmetic to show aggregation](src/pages/3.0.0/images/aggregation.png)
