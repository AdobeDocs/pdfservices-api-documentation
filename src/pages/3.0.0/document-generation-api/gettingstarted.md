...
application. <br/>
To learn more about the Document Generation, read [Overview](src/pages/3.0.0/document-generation-api/index.md)
...
![Document template with heading and template tags](src/pages/3.0.0/images/design_document_templates.gif)
...
Learn more about our [Word Add-in](src/pages/3.0.0/document-generation-api/wordaddin.md).
...
Learn more about [Template Tags](src/pages/3.0.0/document-generation-api/templatetags.md).
...
Before you begin with the REST API, refer [How To Get Started](src/pages/3.0.0/pdf-services-api/howtos/api-usage.md) to learn more about generating the required credentials and invoking the APIs.

**3.2. PDF Services SDK** <br/>
Alternatively, you can use our offering through [PDF Services SDK](src/pages/3.0.0/pdf-services-api#sdk).

<InlineAlert slots="text"/>

To get started with PDF Services SDK, refer [Quickstarts](src/pages/3.0.0/pdf-services-api).
...
![Document template with template tags being replaced by actual values](src/pages/3.0.0/images/generate_document.gif)


#### Generate PDF or Word document (with [Fragments](src/pages/3.0.0/document-generation-api/fragments.md))
