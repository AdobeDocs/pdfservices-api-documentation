...
![Extract sample directory structure](src/pages/3.0.0/images/extractsamplefiles.png)
...
Please refer the [API usage guide](src/pages/3.0.0/pdf-extract-api/howtos/api-usage.md) to understand how to use our APIs.
