...
![Extract sample directory structure](src/pages/images/extractsamplefiles.png)
...
See our public API Reference for [Extract PDF](src/pages/apis/index.md#tag/Extract-PDF).
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Extract-PDF
