...
The [samples and documentation](src/pages/pdf-extract-api/howtos/extract-api.md#extract-text-from-a-pdf) should get you quickly up and running with PDF Extract capabilities in the [PDFServices SDK](src/pages/pdf-extract-api/gettingstarted.md#sdk) including:

- Extracting PDF as JSON: the content, structure & renditions of table and figure elements along with Character Bounding Boxes

For code examples illustrating other PDF actions including those below, see the [PDFServices SDK](src/pages/pdf-extract-api/gettingstarted.md#sdk) :
