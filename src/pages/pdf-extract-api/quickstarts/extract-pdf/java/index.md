...
![Sign in](src/pages/pdf-extract-api/quickstarts/extract-pdf/java/shot1.png)
...
![Project setup](src/pages/pdf-extract-api/quickstarts/extract-pdf/java/shot2-spc.png)

6) After your credentials are created, they are automatically  downloaded:

![alt](src/pages/pdf-extract-api/quickstarts/extract-pdf/java/shot3-spc.png)
...
![alt](src/pages/pdf-extract-api/quickstarts/extract-pdf/java/shot5-spc.png)
...
![Example running in the command line](src/pages/pdf-extract-api/quickstarts/extract-pdf/java/shot9.png)
