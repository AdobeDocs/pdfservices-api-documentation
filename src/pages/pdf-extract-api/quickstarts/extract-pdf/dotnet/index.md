...
![Sign in](src/pages/pdf-extract-api/quickstarts/extract-pdf/dotnet/shot1.png)
...
![Project setup](src/pages/pdf-extract-api/quickstarts/extract-pdf/dotnet/shot2-spc.png)

6) After your credentials are created, they are automatically  downloaded:

![alt](src/pages/pdf-extract-api/quickstarts/extract-pdf/dotnet/shot3-spc.png)
...
![alt](src/pages/pdf-extract-api/quickstarts/extract-pdf/dotnet/shot5-spc.png)
...
![Example running in the command line](src/pages/pdf-extract-api/quickstarts/extract-pdf/dotnet/shot9.png)
