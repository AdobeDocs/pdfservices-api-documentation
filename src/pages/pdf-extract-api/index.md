...
- **Structured JSON output** ([Extract PDF](src/pages/pdf-extract-api/howtos/extract-api.md)): Extracts content and structural information in JSON format
- **Markdown output** ([PDF to Markdown](src/pages/pdf-extract-api/howtos/pdf-to-markdown-api.md)): Converts PDF content to well-formatted, LLM-friendly Markdown text
...
[Learn more about Extract PDF →](src/pages/pdf-extract-api/howtos/extract-api.md)
...
[Learn more about PDF to Markdown →](src/pages/pdf-extract-api/howtos/pdf-to-markdown-api.md)


The PDF Extract API can be embedded into any application using the [PDFServices SDK](src/pages/pdf-extract-api/gettingstarted.md#sdk) for Node.js, Python, .NET and Java. [Start with a Free Tier which includes 500 free Document Transactions per month.](https://acrobatservices.adobe.com/dc-integration-creation-app-cdn/main.html?api=pdf-extract-api)

\</p\>

## Extract Process

![PDF Extract Process : PDF containing title, image, header, paragraph, list and table and provide output as json, png and csv files to client applications](src/pages/images/extract-process-21.png)
