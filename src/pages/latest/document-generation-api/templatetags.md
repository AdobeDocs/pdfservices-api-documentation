...
![image](../images/placeholder_optional.png)
...
The *location-path* specifies the location of base64 encoded image in
the input data.
...
The image placeholder will be replaced by the base64 encoded image in
the output document.
