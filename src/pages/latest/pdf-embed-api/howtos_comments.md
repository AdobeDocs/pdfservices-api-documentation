...
| selector.subtype     | The type of annotation. Permissible values include:<br/>_note_<br/>_highlight_<br/>_shape_<br/>_underline_<br/>_strikeout_<br/>_freetext_                                                                                                                                                                                                                                                 | Yes                                               |
...
must be in the specified in the schema. Either a single annotation or
...
For details, see [Annotation events](#annotation-events)
