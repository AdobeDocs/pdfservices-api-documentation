...
TSP parameters encapsulate the sealer's [certificate credential](src/pages/pdf-services-api/gettingstarted.md#step-1-procure-digital-certificate-credentials) as well as the associated authentication and authorization data.
...
* **TSP Name**  (*providerName*) : **Required** : Specifies the name of the Trust Service Provider used to generate the certificate. Presently, only TSPs supporting the OAuth 2.0 client credential authorization flow are supported. The table below provides the provider name mapping for each supported Trust Service Provider.
  ![TSP Name Mapping](src/pages/images/provider-mapping-ss.png)
...
TSA parameters encapsulate the [timestamping URL and credentials](src/pages/pdf-services-api/gettingstarted.md#step-2-optional-procure-timestamping-url-and-credentials).
...
* **Display Options**  (*displayOptions*): Specifies the information to display in the seal. NAME and LABELS are the default values.
    ...
    * **NAME**: Specifies that the certificate owner's name should be displayed.
      ![Display Options](src/pages/images/name-ss.png)
    ...
    * **SEAL_IMAGE**: Specifies the seal image should be displayed.
      ...
      ![Display Options](src/pages/images/trefoil-ss.png)
...
See our public API Reference for [PDF Electronic Seal API](src/pages/apis/index.md#tag/PDF-Electronic-Seal).
