...
See our public API Reference for the [PDF Accessibility Checker API](src/pages/apis/index.md#tag/PDF-Accessibility-Checker).

## Check accessibility for input PDF

The sample below performs an accessibility check operation on a given PDF.

Please refer to the [API usage guide](src/pages/pdf-services-api/gettingstarted.md) to understand how to use our APIs.
