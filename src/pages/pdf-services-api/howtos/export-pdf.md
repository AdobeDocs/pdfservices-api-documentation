...
- [Export PDF to Office format or text files](src/pages/apis/index.md#tag/Export-PDF)
- [Export PDF to Images](src/pages/apis/index.md#tag/PDF-To-Images)

## Export a PDF

The sample below converts a PDF file into a number of [supported
formats](https://developer.adobe.com/document-services/docs/apis/index.md#tag/Export-PDF)
such as:
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Export-PDF
...
```javascript
// Please refer our REST API docs for more information 
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/PDF-To-Images
