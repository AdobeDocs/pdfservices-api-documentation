...
See our public API Reference for [Linearize PDF](src/pages/apis/index.md#tag/Linearize-PDF)
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Linearize-PDF
