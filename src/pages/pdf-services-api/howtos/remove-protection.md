...
See our public API Reference for [Remove Protection](src/pages/apis/index.md#tag/Remove-Protection)
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Remove-Protection
