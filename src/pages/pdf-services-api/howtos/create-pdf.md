...
- [Create PDF from Office formats](src/pages/apis/index.md#tag/Create-PDF)

- [Create PDF from HTML](src/pages/apis/index.md#tag/Html-To-PDF)

## Create a PDF

Use the sample below to create PDFs from Microsoft Office documents
(Word, Excel and PowerPoint) and other [supported file
formats](https://developer.adobe.com/document-services/docs/apis/index.md#tag/Create-PDF).
...
> **Note:** If a Microsoft Word/PowerPoint input file has an embedded TrueType font, the output pdf will also contain the same embedded TrueType font.
...
> **Note:** We do not support HTML to PDF conversion for requests containing urls where:
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Create-PDF
...
```javascript
// Please refer our REST API docs for more information 
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Html-To-PDF
