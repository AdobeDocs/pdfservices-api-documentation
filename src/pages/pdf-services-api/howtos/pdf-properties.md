...
See our public API Reference for [PDF Properties](src/pages/apis/index.md#tag/PDF-Properties).
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/PDF-Properties
