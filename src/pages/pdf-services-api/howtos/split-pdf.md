...
See our public API Reference for [Split PDF](src/pages/apis/index.md#tag/Split-PDF).
...
// https://developer.adobe.com/document-services/docs/apis/index.md#tag/Split-PDF
