...
![entp signup failure](src/pages/images/entp-signup-failure.png)

#### Step 2:

**Click on** "Get Credentials" button.

![get credentials image](src/pages/images/get-creds-btn.png)

#### Step 3:

**Click on** "Create an account", and **Sign up** using your work email.

![create account](src/pages/images/create-account.png)

#### Step 4:

**Select** "Personal Account" under account types.

![personal account](src/pages/images/personal-account.jpg)

#### Step 5:

**Select**  "Personal Profile" to sign in.

![personal profile](src/pages/images/personal-profile.png)
