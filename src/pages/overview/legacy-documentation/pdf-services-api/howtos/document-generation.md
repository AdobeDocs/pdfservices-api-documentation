---
title: Document Generation API | How Tos | PDF Services API
description: |
  Generate customized PDF or Word documents from Word-based templates
  and JSON input data.
...
Alternatively, you can use our offering through [PDF Services SDK](../index.md#sdk).

<InlineAlert slots="text"/>

To get started with PDF Services SDK, refer [Quickstarts](../index.md).
...
- pdf-services.adobe.io (for versions 3.x.x)
- cpf-ue1.adobe.io (for versions 2.x.x)
...
#### Generate PDF or Word document (with [Fragments](../../document-generation-api/fragments.md))
