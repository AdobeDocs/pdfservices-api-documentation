---
title: Electronic Seal API | How Tos | PDF Services API
description: |
  Reference for supported digital signature formats and PDF Electronic
  Seal API parameters.
...
* PADES : This is the latest and improved signature format which is more strict, concrete, and secure. For details, see [ISO 32000-2](https://www.iso.org/standard/75839.html) and [ETSI EN 319 142-1](https://www.etsi.org/deliver/etsi_en/319100_319199/31914201/01.01.00_30/en_31914201v010100v.pdf).
* PKCS7 : This signature format is less stringent than PADES since it permits more PDF changes without invalidating the digital signature. This is the default signature format. For details, see [ISO 32000-1](https://www.iso.org/standard/51502.html).
