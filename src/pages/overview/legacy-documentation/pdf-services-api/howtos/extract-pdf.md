---
title: Extract API | How Tos | PDF Services API
description: |
  Output format of the PDF Extract SDK operation, including
  structuredData.json and renditions.
...
additional descriptions in the JSON schema):
