...
description: Output of an SDK extract operation is a zip package containing
  structured JSON and renditions.
...
-   The structuredData.json file with the extracted content & PDF
    ...
    schema](/document-services/docs/static/extract-json-output-schema2.json) for a
    description of the default output. (Please refer to the [Styling JSON
    schema](/document-services/docs/static/extract-json-output-schema-styling-info.json)
...
schema](/document-services/docs/static/extract-json-output-schema2.json)):
