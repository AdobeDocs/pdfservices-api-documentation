...
## Autogen Marker
Autogen Marker represents category of Tags whose values are automatically generated by MS Office, and are not derived from input data. They can be of different types like Table of Contents.
