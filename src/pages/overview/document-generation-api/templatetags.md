...
Represents a type of AutoGen Marker which creates table of content section in the document.

#### Usage
![Table of Content tag replaced by Table of Content Section](../images/table_of_content.png)

#### Depth
Depth property can be specified with table of content tag. It represents the levels of subheadings or subsections which are included in the table of contents. It can accept Integer value between 1 and 9. Default value is 3.

![Table of Content tag with depth](../images/table_of_content_depth.png)

#### SkipPageNumbering
SkipPageNumbering property can be specified with table of content tag. It represents whether to skip page numbering for the table of contents. It can accept Boolean value. Default value is false.

![Table of Content tag with skipPageNumbering](../images/table_of_content_skipPageNumbering.png)

<InlineAlert slots="text"/>

- Table of content tag should be placed in a separate paragraph in the input document template. 
- Table of content tag's paragraph should be a part of main body of the document. It cannot be placed inside text box, table or any other object..

### Updating Table of Contents
Templates containing table of contents will be automatically updated post-processing of entire template.
