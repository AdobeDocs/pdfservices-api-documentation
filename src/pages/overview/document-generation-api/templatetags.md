...
## Autogen Marker
Autogen Marker/Tags represents category of Tags whose values are automatically generated by MS Office, and are not derived from input data. They can be of different types like Table of Content, DateTime Field etc.

### Table-of-Contents

Represents a type of AutoGen Marker which creates table of contents section in the document.

#### Usage
![Table of Contents tag replaced by Table of Content Section](../images/table_of_content.png)

#### Depth
Depth property can be specified with table of contents tag. It represents the levels of subheadings or subsections which are included in the table of contents. It can accept Integer value between 1 and 9. Default value is 3.

![Table of Contents tag with depth](../images/table_of_content_depth.png)

#### SkipPageNumbering
SkipPageNumbering property can be specified with table of contents tag. It represents whether to skip page numbering for the table of contents. It can accept Boolean value. Default value is false.

![Table of Contents tag with skipPageNumbering](../images/table_of_content_skipPageNumbering.png)

<InlineAlert slots="text"/>

- Table of contents tag should be placed in a separate paragraph in the input document template. 
- Table of contents tag's paragraph should be a part of main body of the document. It cannot be placed inside text box, table or any other object.

### Updating Table of Contents
Templates containing table of contents section will be automatically updated post-processing of entire template.
