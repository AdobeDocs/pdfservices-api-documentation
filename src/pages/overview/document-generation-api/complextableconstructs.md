...
This section is deprecated. To continue using complex table constructs, please refer to [Complex Table Constructs with Table markers](../document-generation-api/tablewithmarkers.md#complex-table-constructs-with-table-markers).
