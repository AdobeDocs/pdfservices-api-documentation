...
This section is <span style="color:red">DEPRECATED</span>. To continue using complex table constructs, please refer to [Complex Table Constructs with Table markers](tablewithmarkers.md#complex-table-constructs-with-table-markers).
