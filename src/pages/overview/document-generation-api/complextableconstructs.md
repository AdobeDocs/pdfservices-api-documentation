---
title: Complex table constructs (deprecated)
description: Deprecated: use table markers instead. Extend rows or columns, discard columns or rows, and use cell-extension in Word templates.
---
# Complex Table Constructs
Add additional properties to table tags to apply advanced functionalities on table.

This section is **DEPRECATED**. To continue using complex table constructs, please refer to [Complex Table Constructs with Table markers](tablewithmarkers.md#complex-table-constructs-with-table-markers).
...
- [Discard column if empty](complextableconstructs.md#discard-column-if-empty).
- [Discard column if condition evaluates to true](complextableconstructs.md#discard-column-if-condition-evaluates-to-true).
