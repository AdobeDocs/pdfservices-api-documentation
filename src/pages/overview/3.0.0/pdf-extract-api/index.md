...
The PDF Extract API can be embedded into any application using the [PDFServices SDK](../pdf-services-api/index.md#sdk) for Node.js, Python, .NET and Java. [Start a Free Tier which includes 5,000 free Document Transactions every 30 days.](https://documentservices.adobe.com/dc-integration-creation-app-cdn/main.html?api=pdf-extract-api)
