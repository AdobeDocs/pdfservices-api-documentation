...
You can read more about the API in detail [here](https://developer.adobe.com/document-services/docs/apis/#tag/Assets/operation/asset.uploadpresignedurl).
...
You can read more about the API in detail [here](https://developer.adobe.com/document-services/docs/apis/#tag/Compress-PDF/operation/pdfoperations.compresspdf.jobstatus).
...
You can read more about the API in detail [here](https://developer.adobe.com/document-services/docs/apis/#tag/Assets/operation/asset.get).
