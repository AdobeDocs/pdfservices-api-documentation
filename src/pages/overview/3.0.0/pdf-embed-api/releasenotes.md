...
| Bug fix | Fixed issue in the Inline Embed mode where Blue Line gets displayed around PDF.
| Bug fix | Fixed issue in the Inline Embed mode where Error message not displayed for invalid client Id.
