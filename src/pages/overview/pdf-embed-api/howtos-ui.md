...
description: 
  Customize the PDF Embed API viewer UI and user interactions, including
  commenting, download and print options, and Fit Page or Fit Width display.
---
...
| locale | "en-US" | You can select another language by passing the locale code variable. For more details, see the section [Language support](howtos.md#language-support). |
...
| showAnnotationTools | *true*                         | If *true*, tools such as add text, sticky note, highlight, and so on appear in the quick tools menu on the left-hand side in full window embed mode. For more details, see [Comments and Markup](howtos-comments.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| enableAnnotationAPIs| *false*                        | Set this to *true* to add, update and delete PDF annotations programmatically in full window embed mode. For more details, see the section [Annotations API overview](howtos-comments.md#annotations-api-overview).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| includePDFAnnotations | *false*                        | This configuration is used with `enableAnnotationAPIs` to access existing PDF annotations. For more details, see the section [Annotations API overview](howtos-comments.md#annotations-api-overview).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| enableSearchAPIs | *false*                        | Set this to *true* to perform search operation in the PDF programmatically. For more details, see the section [Search APIs](howtos-ui.md#search-apis).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| focusOnRendering | Varies according to embed mode | With this configuration, website developers have the flexibility to control if the PDF should take focus when it is rendered. For more details, see the section [Focus on PDF rendering](howtos.md#focus-on-pdf-rendering).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
For details, see [Comments and Markup](howtos-comments.md).
...
![User being referred to as guest](../images/userprofile-new.png)
...
![File Modified message](../images/file-modified.png)
