...
- Added support for [Export PDF Form Data](howtos/export-pdf-form-data.md) and [Import PDF Form Data](howtos/import-pdf-form-data.md) operations in PDF Services Python SDK, enabling users to extract and populate form Data.

### May 22, 2025; .NET SDK 4.3.0 Release

- Added support for [Export PDF Form Data](howtos/export-pdf-form-data.md) and [Import PDF Form Data](howtos/import-pdf-form-data.md) operations in PDF Services .NET SDK, enabling users to extract and populate form Data.
...
- Added support for [Export PDF Form Data](howtos/export-pdf-form-data.md) and [Import PDF Form Data](howtos/import-pdf-form-data.md) operations in PDF Services Java SDKs, enabling users to extract and populate form Data.
...
- Added [Export PDF Form Data API](howtos/export-pdf-form-data.md) operation in PDF Services API to retrieve the data from a PDF form and return it as a JSON file.
- Added [Import PDF Form Data API](howtos/import-pdf-form-data.md) operation in PDF Services API to populate PDF forms with JSON data and generate the resulting PDF document.
...
- Added [PDF Accessibility Checker](howtos/pdf-accessibility-checker-api.md) operation in PDF Services API to check accessibility on specified pages of PDF document.
...
- Bug fixes [Get PDF Properties](howtos/pdf-properties.md) fixed data issue related to permissions in JSON response.

### July 09, 2024; Server Side Release

- Added [PDF Watermark](howtos/pdf-watermark-api.md) operation in PDF Services API to add a watermark on specified pages of PDF document.
...
- Added support for [Webhook Notification](howtos/webhook-notification.md) in PDF Properties.
- Added support for [External Storage](howtos/pdf-external-storage-sol.md) in Extract PDF, Split PDF, PDF Electronic Seal and Auto-Tag PDF.
- Added support for [Webhook Notification](howtos/webhook-notification.md) for external storage operations.
...
- Added support for [Webhook Notification](howtos/webhook-notification.md) in all the operations **except** PDF Properties.
...
- Added support for [External Storage](howtos/pdf-external-storage-sol.md) in all the operations **except** Extract PDF, Split PDF, PDF Electronic Seal and Auto-Tag PDF.
...
- Added support for [External Storage](howtos/pdf-external-storage-sol.md) in Document Generation API.
