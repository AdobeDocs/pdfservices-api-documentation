    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                Stream outputStream = File.OpenWrite(Directory.GetCurrentDirectory() + "/output/ocrOperationOutput.pdf");
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                // Creating output streams and copying stream asset's content to it
                Stream outputStream = File.OpenWrite(Directory.GetCurrentDirectory() + "/output/ocrOperationWithOptionsOutput.pdf");
                streamAsset.Stream.CopyTo(outputStream);
                outputStream.Close();
            }
            catch (ServiceUsageException ex)
